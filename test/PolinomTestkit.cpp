...
TEST(TPolinom, Unequal_Polinoms_Are_Not_Equal_1)
{
    int mon1[][2] = { {-10, 322}, {2, 161} };
    int mon2[][2] = { {-10, 322} };
    TPolinom p1(mon1, 2);
    TPolinom p2(mon2, 1);
...
TEST(TPolinom, Unequal_Polinoms_Are_Not_Equal_2)
{
    int mon1[][2] = { {88888, 100}, {-1111, 678} };
    int mon2[][2] = { {88888, 100}, {4320, 203} };
    TPolinom p1(mon1, 2);
    TPolinom p2(mon2, 2);
